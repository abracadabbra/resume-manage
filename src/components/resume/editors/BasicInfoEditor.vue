  ...
  <section class="editor-section">
    ...
    <div v-show="!collapsed" class="section-body">
      ...
      <div class="form-grid-1">
        <div class="form-group">
          <label class="form-label">头部信息（第1行）</label>
          <input v-model="store.basicInfo.line1" type="text" class="form-input" placeholder="例如：30岁 · 15167195271 · daydreamer@linux.do · 杭州" />
        </div>
        <div class="form-group">
          <label class="form-label">头部信息（第2行）</label>
          <input v-model="store.basicInfo.line2" type="text" class="form-input" placeholder="例如：软件工程师" />
        </div>
        <div class="form-group">
          <label class="form-label">头部信息（第3行）</label>
          <input v-model="store.basicInfo.line3" type="text" class="form-input" placeholder="例如：E类人才 · 政采云评审专家 · 浙江省工程师学会会员" />
        </div>
        <div class="form-group">
          <label class="form-label">头部信息（第4行）</label>
          <input v-model="store.basicInfo.line4" type="text" class="form-input" placeholder="例如：可选" />
        </div>
      </div>
